...
export function RecipeModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="w-full h-[100dvh] sm:max-w-6xl sm:h-auto sm:max-h-[90vh] p-0 border-none bg-white sm:rounded-lg">
        ...
        <DialogClose className="absolute top-4 right-4 z-[100] w-12 h-12 rounded-full bg-white hover:bg-gray-50 text-[#465E5A] flex items-center justify-center transition-all shadow-lg">
        ...
        <div className="h-full grid grid-rows-[1fr,auto]">
          ...
          <div className="bg-white border-t border-gray-200 px-4 sm:px-8 py-4 sm:py-6 safe-area-bottom">
            <div className="grid grid-cols-2 gap-3 sm:gap-4 max-w-6xl mx-auto">
              <button
                onClick={handleAddToMealPlan}
                className={`py-3 sm:py-4 px-4 sm:px-6 border-2 rounded-lg transition-all font-medium text-sm sm:text-base ${
                  isAddedToMealPlan
              ...
              <button
                ...
                className={`py-3 sm:py-4 px-4 sm:px-6 rounded-lg transition-all font-medium text-sm sm:text-base ${
                  isFavorite
