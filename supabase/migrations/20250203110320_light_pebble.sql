/*
  ...
  1. New Tables
    - `goals` - Stores user goals with progress tracking
    - `achievements` - Stores available achievements
    - `user_achievements` - Tracks unlocked achievements per user
    - `rewards` - Stores available rewards
    - `user_rewards` - Tracks claimed rewards per user
...
INSERT INTO achievements (title, description, image_url, points) VALUES
  ...
  ('Hydration Hero', 'Meet your daily water intake goal for 7 days straight', 'https://api.dicebear.com/7.x/shapes/svg?seed=achievement4', 150),
  ('Nutrition Master', 'Complete 3 nutrition goals', 'https://api.dicebear.com/7.x/shapes/svg?seed=achievement5', 175);
...
INSERT INTO rewards (title, description, image_url, points_cost, type) VALUES
  ...
  ('Weekly Meal Planner', 'Advanced meal planning tools', 'https://api.dicebear.com/7.x/shapes/svg?seed=reward4', 400, 'template'),
  ('Smoothie Recipe Collection', 'Collection of healthy smoothie recipes', 'https://api.dicebear.com/7.x/shapes/svg?seed=reward5', 250, 'recipe');
